...
namespace Game.UI.GameScene
{
    public class GameSceneUIManager : BasePanel
    {
        ...
        [Header("功能面板")] public NationSettingPanel nationPanel;
        public EventTimelinePanel timelinePanel;

        [Header("功能按钮")] public Button btnOpenNation;
        public Button btnOpenTimeline;

        [Header("地图显示")] public RawImage mapDisplayRawImage;
        public MapViewerController mapViewer;

        [Header("需要隐藏/显示的UI")] public GameObject topNav; // 顶部导航
